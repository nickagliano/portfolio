        ...
        <div className="resume">
                <div className="base">
                    <div className="profile">
                        ...
                        <div className="info">
                            <h4 className="name">Nick Agliano</h4><small className="job">Software Developer</small></div>
                    </div>
                    <div className="about">
                        <h3>About me</h3>嗨！目前正努力學習中，希望自己的進步及成長能夠被看見，請多指教。<br/>喜歡塗鴉、動漫和美好的小事物，歡迎交流 v(´∀｀*v)</div>
                    <div className="contact">
                        <h3>Contact</h3>
                        <div className="call"><i className="fa fa-phone"></i><span>(+886)900-000-000</span></div>
                        <div className="address"><i className="fa fa-map-marker"></i><span>Taipei, Taiwan</span></div>
                        <div className="email"><i className="fa fa-envelope"></i><span>ヽ(*´∀`)@gmail.com</span></div>
                        <div className="website"><a href="http://codepen.io/xichen" target="_blank"> <i className="fa fa-home"></i><span>codepen.io/xichen</span></a></div>
                    </div>
                    <div className="follow">
                        <h3>Follow</h3>
                        <div className="box"><a href="javascript:void(0);"><i className="fa fa-facebook"></i></a><a href="javascript:void(0);"><i className="pif-plurkapp"></i></a><a href="javascript:void(0);"><i className="fa fa-twitter"></i></a><a href="javascript:void(0);"><i className="fa fa-pinterest-p"></i></a>
                            <a
                                href="javascript:void(0);"><i className="fa fa-tumblr"></i></a><a href="https://codepen.io/xichen/" target="_blank"><i className="fa fa-codepen"></i></a></div>
                    </div>
                </div>
                <div className="func">
                    <div className="work">
                    ...
                    <div className="skills-soft">
                        ...
                        <ul>
                            <li data-percent="94"><svg viewBox="0 0 100 100"><circle cx="50" cy="50" r="45"></circle><circle className="cbar" cx="50" cy="50" r="45"></circle></svg><span>Photoshop</span><small></small></li>
                            <li data-percent="80"><svg viewBox="0 0 100 100"><circle cx="50" cy="50" r="45"></circle><circle className="cbar" cx="50" cy="50" r="45"></circle></svg><span>Illustrator</span><small></small></li>
                            <li data-percent="89"><svg viewBox="0 0 100 100"><circle cx="50" cy="50" r="45"></circle><circle className="cbar" cx="50" cy="50" r="45"></circle></svg><span>Sublime Text</span><small></small></li>
                            <li data-percent="55"><svg viewBox="0 0 100 100"><circle cx="50" cy="50" r="45"></circle><circle className="cbar" cx="50" cy="50" r="45"></circle></svg><span>Dreamweaver</span><small></small></li>
                        </ul>
                    </div>
